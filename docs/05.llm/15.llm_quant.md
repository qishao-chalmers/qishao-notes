...
13. [55] QLLM: Accurate and Efficient Low-Bitwidth Quantization for Large Language Models
...
18. [73] FP8 Quantization: The Power of the Exponent
19. [UnRead 121] Training High-Performance and Large-Scale Deep Neural Networks with Full 8-bit Integers
20. [381] I-BERT: Integer-only BERT Quantization
21. [637] Training Deep Neural Networks with 8-bit Floating Point Numbers
22. [904] LLM.int8(): 8-bit Matrix Multiplication for Transformers at Scale
23. [UnRead 2568] DoReFa-Net: Training Low Bitwidth Convolutional Neural Networks with Low Bitwidth Gradients :+1:
24. [239] Model Accuracy and Runtime Tradeoff in Distributed Deep Learning: A Systematic Study :+1:
...
## 23. [Y2024]Integer Scale: A Free Lunch for Faster Fine-grained Quantization of LLMs
### Overview
