...
3. [C24 2024] Tensor Attention Training: Provably Efficient Learning of Higher-order Transformers
4. [2024] When Attention Sink Emerges in Language Models: An Empirical View :+1:
5. [C40 2024] Soaring from 4K to 400K: Extending LLM's Context with Activation Beacon
...
22. [C0 2024] Densing Law of LLMs
23. [C9 2024] Demystifying the Compression of Mixture-of-Experts Through a Unified Framework
24. [C7 2024] Configurable Foundation Models: Building LLMs from a Modular Perspective
25. [C2 2024] Task Scheduling for Efficient Inference of Large Language Models on Single Moderate GPU Systems
26. [C7 2024] Towards Sustainable Large Language Model Serving :+1:
27. [C42 2024] LayerSkip: Enabling Early Exit Inference and Self-Speculative Decoding
...
![image](https://github.com/user-attachments/assets/70208eed-9009-4677-a017-57a14773dfb8)

Instead of calculating QK, it calculates KV.

![image](https://github.com/user-attachments/assets/9a6ec80b-8119-47fc-8198-851803dcff6d)

![image](https://github.com/user-attachments/assets/f81039ea-43fd-43c5-a5d7-6b9787459a1b)

Figure from: Gaussian‑Linearized Transformer

Class calculation complexity:

![image](https://github.com/user-attachments/assets/5902c7ec-ac3d-4bbd-92bb-fa95c82208f5)

Provided the model dimension is << sequence length, 

compute complexity in linear attention:

![image](https://github.com/user-attachments/assets/134b7825-1f53-4811-b101-25b6ce251316)

[Figure From](https://towardsdatascience.com/linear-attention-is-all-you-need-5fa9c845c1b5)
...
![image](https://github.com/user-attachments/assets/be3c6aaf-d33f-42d7-8f15-4b57a8fa9b15)

![image](https://github.com/user-attachments/assets/0c345baa-5481-43f8-9f07-9d88dd9f7644)
...
![image](https://github.com/user-attachments/assets/b64ad8ac-bbba-409d-919d-b438c1859b5a)
