...
16. [C1325 2019] Analyzing Multi-Head Self-Attention: Specialized Heads Do the Heavy Lifting, the Rest Can Be Prune
17. [C101] An Analysis of Attention Mechanisms: The Case of Word Sense Disambiguation in Neural Machine Translation
18. [C38517 2020] Language Models are Few-Shot Learners :+1:
19. [C24 2024] What can a Single Attention Layer Learn? A Study Through the Random Features Lens
20. [C9 2023] Analyzing Feed-Forward Blocks in Transformers through the Lens of Attention Maps
21. [C606 2021] Transformer Feed-Forward Layers Are Key-Value Memories :+1:
22. [Blog] The Feedforward Demystified: A Core Operation of Transformers
23. [C211 2024] ConvBERT: Improving BERT with Span-based Dynamic Convolution  :+1:
24. [C15 2020] Convolutions and Self-Attention: Re-interpreting Relative Positions in Pre-trained Language Models
25. [C147 2023] Towards Revealing the Mystery behind Chain of Thought: A Theoretical Perspective
26. [C24 2024] MInference 1.0: Accelerating Pre-filling for Long-Context LLMs via Dynamic Sparse Attention
27. [C0 2024] Densing Law of LLMs
28. [C9 2024] Demystifying the Compression of Mixture-of-Experts Through a Unified Framework
29. [C7 2024] Configurable Foundation Models: Building LLMs from a Modular Perspective
30. [C2 2024] Task Scheduling for Efficient Inference of Large Language Models on Single Moderate GPU Systems
31. [C7 2024] Towards Sustainable Large Language Model Serving :+1:
32. [C42 2024] LayerSkip: Enabling Early Exit Inference and Self-Speculative Decoding
33. [C10395 0221] GPT Understands,Too
34. [C36 2023] Simplifying Transformer Blocks
35. [C2 2024] When a language model is optimized for reasoning, does it still show embers of autoregression? An analysis of OpenAI o1
36. [C188 2023] LLM-Blender: Ensembling Large Language Models with Pairwise Ranking and Generative Fusion
