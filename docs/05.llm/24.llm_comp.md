...
4. [4 2025] BCQ: Block Clustered Quantization for 4-bit (W4A4) LLM Inference
...
This is clustering blocks (block clustering quantization) and also iterates between steps of block clustering and codebook design to greedily minize the quantization mean squared error.

<img width="961" height="502" alt="image" src="https://github.com/user-attachments/assets/2aacf55c-ce11-4cc0-9f4d-97cd23a92224" />

<img width="640" height="227" alt="image" src="https://github.com/user-attachments/assets/486185ca-962a-44d9-857d-d02f2e0cfc9b" />

If we make an analogy of vector clustering, each block is like a vector. The length of block is block length. The group size is the number of blocks and codebook size is the number of cluster center.
