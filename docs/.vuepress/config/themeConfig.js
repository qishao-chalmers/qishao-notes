rconst nav = require('./themeConfig/nav.js');
...
module.exports = {
  ...
  editLinkText: 'Advice to improve the page',
  searchPlaceholder: "Enter 𝑺 search",  // 可选：搜索栏占位文本，默认："$ grep ..."
  ...
  author: {
    ...
    name: 'hitqishao', // 必需
    link: 'https://github.com/hitqshao', // 可选的
  },
  social: {
    // 社交图标，显示于博主信息栏和页脚栏
    ...
    icons: [
      {
        ...
        title: 'GitHub',
        link: 'https://github.com/hitqshao',
      },
      {
        iconClass: 'icon-youjian',
        title: '发邮件',
        link: 'mailto:hitqshao@163.com',
      },
      {
        iconClass: 'icon-gitee',
        title: 'Gitee',
        link: 'https://gitee.com/hitqshao',
      },
    ],
  },
  footer: {
    ...
    copyrightInfo:
      'Eryajf | <a href="https://github.com/hitqshao/qishao-notes/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  }
}
